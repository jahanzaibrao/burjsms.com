...
!(function ($) {
	var DateRangePicker = function (element, options, cb) {
		...
		var DRPTemplate =
			...
			"</div>" +
			'<button class="btn btn-small btn-success applyBtn" disabled="disabled">' +
			this.locale.applyLabel +
			"</button>&nbsp;" +
			'<button class="btn btn-small clearBtn">' +
	...
	DateRangePicker.prototype = {
		...
		enterDate: function (e) {
			var title = $(e.target).attr("title") || $(e.target).attr("data-original-title");
