!(function (e) {
	...
	function i(i, p) {
		...
		function c(e) {
			var t;
			return (
				(t = null == e ? _() : _.isDate(e) || _.isMoment(e) ? _(e) : a() ? _.tz(e, B, p.useStrict, p.timeZone) : _(e, B, p.useStrict)),
				a() && t.tz(p.timeZone),
				t
			);
		}
				...
				o = [
					...
					d("h") &&
						(e.append(
							$("<td>").append(
								$("<a>")
									.attr({ href: "#", tabindex: "-1", title: p.tooltips.incrementHour })
									.addClass("btn")
						...
						t.append(
							$("<td>").append(
								$("<span>")
									...
									.attr({ "data-time-component": "hours", title: p.tooltips.pickHour })
						...
						a.append(
							$("<td>").append(
								$("<a>")
									.attr({ href: "#", tabindex: "-1", title: p.tooltips.decrementHour })
									.addClass("btn")
					...
					d("m") &&
						...
						e.append(
							$("<td>").append(
								$("<a>")
									.attr({ href: "#", tabindex: "-1", title: p.tooltips.incrementMinute })
									.addClass("btn")
						...
						t.append(
							$("<td>").append(
								$("<span>")
									...
									.attr({ "data-time-component": "minutes", title: p.tooltips.pickMinute })
						...
						a.append(
							$("<td>").append(
								$("<a>")
									.attr({ href: "#", tabindex: "-1", title: p.tooltips.decrementMinute })
									.addClass("btn")
					...
					d("s") &&
						...
						e.append(
							$("<td>").append(
								$("<a>")
									.attr({ href: "#", tabindex: "-1", title: p.tooltips.incrementSecond })
									.addClass("btn")
						...
						t.append(
							$("<td>").append(
								$("<span>")
									...
									.attr({ "data-time-component": "seconds", title: p.tooltips.pickSecond })
						...
						a.append(
							$("<td>").append(
								$("<a>")
									.attr({ href: "#", tabindex: "-1", title: p.tooltips.decrementSecond })
									.addClass("btn")
					...
					Y ||
						...
						t.append(
							$("<td>").append(
								$("<button>").addClass("btn btn-primary").attr({ "data-action": "togglePeriod", tabindex: "-1", title: p.tooltips.togglePeriod })
							)
						),
						a.append($("<td>").addClass("separator"))),
					$("<div>")
			...
			var e,
				...
				r = $("<div>")
					...
					.append(
						((t = $("<thead>").append(
							$("<tr>")
								.append($("<th>").addClass("prev").attr("data-action", "previous").append($("<span>").addClass(p.icons.previous)))
								.append(
									$("<th>")
								...
								.append($("<th>").addClass("next").attr("data-action", "next").append($("<span>").addClass(p.icons.next)))
						)),
				...
				s = $("<li>")
					...
					.append(
						...
						p.showTodayButton &&
							e.push(
								$("<td>").append($("<a>").attr({ "data-action": "today", title: p.tooltips.today }).append($("<span>").addClass(p.icons.today)))
							),
						!p.sideBySide &&
							u() &&
							l() &&
							e.push(
								$("<td>").append(
									$("<a>").attr({ "data-action": "togglePicker", title: p.tooltips.selectTime }).append($("<span>").addClass(p.icons.time))
								)
							),
						p.showClear &&
							e.push(
								$("<td>").append($("<a>").attr({ "data-action": "clear", title: p.tooltips.clear }).append($("<span>").addClass(p.icons.clear)))
							),
						p.showClose &&
							e.push(
								$("<td>").append($("<a>").attr({ "data-action": "close", title: p.tooltips.close }).append($("<span>").addClass(p.icons.close)))
							),
						$("<table>")
		...
		function n() {
			...
			if (
				("auto" === n &&
					(n = a.top + 1.5 * N.height() >= $(window).height() + $(window).scrollTop() && N.height() + i.outerHeight() < a.top ? "top" : "bottom"),
		...
		function r(e) {
			"y" === e && (e = "YYYY"), h({ type: "dp.update", change: e, viewDate: H.clone() });
		}
		function o(e) {
			N &&
		...
		function s() {
			...
			if (u()) {
				for (
					...
					0 === e.weekday() && ((t = $("<tr>")), p.calendarWeeks && t.append('<td class="cw">' + e.week() + "</td>"), i.push(t)),
						(o = ["day"]),
				...
				(function () {
					...
					for (11 < H.hour() && !Y && t.hour(12); t.isSame(H, "d") && (Y || (H.hour() < 12 && t.hour() < 12) || 11 < H.hour()); )
						t.hour() % 4 == 0 && ((n = $("<tr>")), a.push(n)),
							n.append('<td data-action="selectHour" class="hour' + (m(t, "h") ? "" : " disabled") + '">' + t.format(Y ? "HH" : "hh") + "</td>"),
							t.add(1, "h");
					e.empty().append(a);
				})(),
				(function () {
					for (
						var e = N.find(".timepicker-minutes table"), t = H.clone().startOf("h"), a = [], n = $("<tr>"), r = 1 === p.stepping ? 5 : p.stepping;
						H.isSame(t, "h");

					)
						t.minute() % (4 * r) == 0 && ((n = $("<tr>")), a.push(n)),
							n.append('<td data-action="selectMinute" class="minute' + (m(t, "m") ? "" : " disabled") + '">' + t.format("mm") + "</td>"),
							t.add(r, "m");
					e.empty().append(a);
				})(),
				(function () {
					for (var e = N.find(".timepicker-seconds table"), t = H.clone().startOf("m"), a = [], n = $("<tr>"); H.isSame(t, "m"); )
						t.second() % 20 == 0 && ((n = $("<tr>")), a.push(n)),
							n.append('<td data-action="selectSecond" class="second' + (m(t, "s") ? "" : " disabled") + '">' + t.format("ss") + "</td>"),
							t.add(5, "s");
					e.empty().append(a);
				})();
		}
		...
		function g(e) {
			var t = W ? null : E;
			if (!e) return (W = !0), I.val(""), i.data("date", ""), h({ type: "dp.change", date: !1, oldDate: t }), void y();
			if (((e = e.clone().locale(p.locale)), a() && e.tz(p.timeZone), 1 !== p.stepping))
				for (e.minutes(Math.round(e.minutes() / p.stepping) * p.stepping).seconds(0); p.minDate && e.isBefore(p.minDate); )
			...
			m(e)
				...
				: (p.keepInvalid ? h({ type: "dp.change", date: e, oldDate: t }) : I.val(W ? "" : E.format(q)), h({ type: "dp.error", date: e, oldDate: t }));
		}
		function b() {
			var t = !1;
			return N
			...
			return (
				I.prop("disabled") ||
					...
					(function () {
						...
						for (!0 === p.calendarWeeks && e.append($("<th>").addClass("cw").text("#")); t.isBefore(H.clone().endOf("w")); )
							e.append($("<th>").addClass("dow").text(t.format("dd"))), t.add(1, "d");
						N.find(".datepicker-days thead").append(e);
					})(),
					(function () {
						for (var e = [], t = H.clone().startOf("y").startOf("d"); t.isSame(H, "y"); )
							e.push($("<span>").attr("data-action", "selectMonth").addClass("month").text(t.format("MMM"))), t.add(1, "M");
		...
		var E,
			...
			X = {
				...
				selectMonth: function (e) {
					...
					H.month(t), j === V ? (g(E.clone().year(H.year()).month(H.month())), p.inline || b()) : (o(-1), s()), r("M");
				},
				selectYear: function (e) {
					var t = parseInt($(e.target).text(), 10) || 0;
					H.year(t), j === V ? (g(E.clone().year(H.year())), p.inline || b()) : (o(-1), s()), r("YYYY");
				},
				...
				selectHour: function (e) {
					...
					Y || (12 <= E.hours() ? 12 !== t && (t += 12) : 12 === t && (t = 0)), g(E.clone().hours(t)), X.showPicker.call(L);
				},
		...
		if (
			...
			(L.date = function (e) {
				...
				if (!(null === e || "string" == typeof e || _.isMoment(e) || e instanceof Date))
			...
			(L.defaultDate = function (e) {
				...
				return (p.defaultDate = t), ((p.defaultDate && p.inline) || "" === I.val().trim()) && g(p.defaultDate), L;
			}),
			(L.locale = function (e) {
			...
			(L.widgetPositioning = function (e) {
				...
				if (e.horizontal) {
					...
					if (((e.horizontal = e.horizontal.toLowerCase()), -1 === U.indexOf(e.horizontal)))
						throw new TypeError("widgetPositioning() expects horizontal parameter to be one of (" + U.join(", ") + ")");
				...
				if (e.vertical) {
					...
					if (((e.vertical = e.vertical.toLowerCase()), -1 === Q.indexOf(e.vertical)))
						throw new TypeError("widgetPositioning() expects vertical parameter to be one of (" + Q.join(", ") + ")");
			...
			(L.widgetParent = function (e) {
				...
				if (("string" == typeof e && (e = $(e)), null !== e && "string" != typeof e && !(e instanceof $)))
		...
		if (
			(i.hasClass("input-group") && (z = 0 === i.find(".datepickerbutton").length ? i.find(".input-group-addon") : i.find(".datepickerbutton")),
			!p.inline && !I.is("input"))
		)
		...
		return (
			...
			$.extend(
				...
				p,
				((F = {}),
				(A = i.is("input") || p.inline ? i.data() : i.find("input").data()).dateOptions &&
