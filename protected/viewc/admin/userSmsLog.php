        ...
        <section class="app-content">
            <nav class="searchbar navbar fixed-top navbar-expand-lg navbar-light bg-white m-b-0">
                ...
                <div class="navbar-nav clearfix col-md-8 p-t-sm">
                    <!-- User selector -->
                    <div class="nav-item col-md-3 p-v-xs">
                    ...
                    <!-- Mobile selector -->
                    <div class="nav-item col-md-4 p-v-xs">
                        <div class="input-group ">
            ...
            <div class="darksearchbar fixed-top bg-dark text-light p-t-sm p-v-sm p-b-xs col-md-12">
                <div class="col-md-3">
                    <ul class="list-group bg-dark m-b-0">
                            ...
                            <div class="btn-group" style="vertical-align: top;">
                                ...
                                <ul id="s_route_dropdown" class="dropdown-menu search-options-bar">
                                    ...
                                    <?php foreach ($data['routes'] as $rt) { ?>
                                        <li><a class="search_option_selector routeslist" data-inputid="s_route" data-myvalue="<?php echo $rt->id ?>" href="javascript:void(0);"><?php echo $rt->title ?></a> </li>
                                    <?php } ?>
                                </ul>
                            </div>
                        ...
                        <li class="bg-dark m-b-xs" style="vertical-align: middle;">
                            <span class="darksearchbar-param-title">SMPP:</span>
                            <div class="btn-group" style="vertical-align: top;">
                                <button id="s_smpp_selection" class="btn btn-primary btn-xs dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Any <i class="m-l-sm fas fa-caret-down fa-lg"></i>
                                </button>
                                <ul id="s_smpp_dropdown" class="dropdown-menu search-options-bar">
                                    <li><a class="search_option_selector chosen" data-inputid="s_smpp" data-myvalue="" href="javascript:void(0);">Any</a> </li>
                                    <?php foreach ($data['smpp'] as $smsc) { ?>
                                        <li><a class="search_option_selector smpplist" data-inputid="s_smpp" data-myvalue="<?php echo $smsc->smsc_id ?>" href="javascript:void(0);"><?php echo $smsc->provider == "" ? $smsc->title : $smsc->title . '<span class="fz-sm m-l-xs fs-italic"> by ' . $smsc->provider . '</span>' ?></a> </li>
                                    <?php } ?>
                                </ul>
                            </div>
                ...
                <div class="col-md-3">
                    <ul class="list-group bg-dark m-b-0">
                        <li class="bg-dark m-b-xs" style="vertical-align: middle;">
                            <span class="darksearchbar-param-title">Delivery Type:</span>
                            <div class="btn-group" style="vertical-align: top;">
                                <button id="s_fakedlr_selection" class="btn btn-primary btn-xs dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Any <i class="m-l-sm fas fa-caret-down fa-lg"></i>
                                </button>
                                <ul id="s_fakedlr_dropdown" class="dropdown-menu search-options-bar">
                                    <li><a class="search_option_selector chosen" data-inputid="s_fakedlr" data-myvalue="" href="javascript:void(0);">Any</a> </li>
                                    <li><a class="search_option_selector" data-inputid="s_fakedlr" data-myvalue="normal" href="javascript:void(0);">Normal</a> </li>
                                    <li><a class="search_option_selector" data-inputid="s_fakedlr" data-myvalue="fakedlr" href="javascript:void(0);">Fake DLR</a></li>
                                </ul>
                            </div>
                            <input type="hidden" id="s_fakedlr" value="">
                        </li>
                        <li class="bg-dark m-b-xs" style="vertical-align: middle;">
                    ...
                    <ul class="list-group bg-dark m-b-0">
                        <li class="bg-dark m-b-xs" style="vertical-align: middle;">
                            ...
                            <div class="form-group">
                                <textarea style="min-height: 65px; height: 90px;" class="form-control" id="s_smstext" placeholder="enter pharses or text to match..."></textarea>
                            </div>
                        </li>
                    </ul>
                </div>
