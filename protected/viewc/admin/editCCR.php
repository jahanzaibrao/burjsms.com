                ...
                <div class="col-md-12">
                    <div class="widget p-lg">
                        <div class="row no-gutter">
                            <h3 class="page-title-sc"><?php echo SCTEXT('Edit Credit Count Rule') ?><small><?php echo SCTEXT('modify character count rules') ?></small></h3>
                            <hr>
                            <?php include('notification.php') ?>
                            <div class="col-md-12">
                                <!-- start content -->
                                <form class="form-horizontal form-wizard" method="post" id="add_rule_form" action="">
                                    <input type="hidden" name="rid" value="<?php echo $data['rdata']->id ?>" />
                                    <?php
                                    $normal_rule = json_decode($data['rdata']->normal_sms_rule, true);
                                    $unicode_rule = json_decode($data['rdata']->unicode_rule, true);
                                    $spcl_rule = json_decode($data['rdata']->special_chars_rule, true);
                                    ?>
                                    ...
                                    <div id="step-1-form" class="block">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="ccrname" id="ccrname" class="form-control" placeholder="<?php echo SCTEXT('enter a title for this rule') ?>" maxlength="50" value="<?php echo $data['rdata']->rule_name ?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                ...
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="normal_chars[1][to]" data-count="1" placeholder="e.g. 160" value="<?php echo $normal_rule[1]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($normal_rule[1]['to']) / 1 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                ...
                                                                <input type="text" class="form-control input-small-sc input-sm bg-white" readonly name="normal_chars[2][from]" placeholder="" value="<?php echo $normal_rule[2]['from'] ?>" />
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="normal_chars[2][to]" data-count="2" placeholder="" value="<?php echo $normal_rule[2]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($normal_rule[2]['to']) / 2 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                ...
                                                                <input type="text" class="form-control input-small-sc input-sm bg-white" readonly name="normal_chars[3][from]" placeholder="" value="<?php echo $normal_rule[3]['from'] ?>" />
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="normal_chars[3][to]" data-count="3" placeholder="" value="<?php echo $normal_rule[3]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($normal_rule[3]['to']) / 3 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                ...
                                                                <input type="text" class="form-control input-small-sc input-sm bg-white" readonly name="normal_chars[4][from]" placeholder="" value="<?php echo $normal_rule[4]['from'] ?>" />
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="normal_chars[4][to]" data-count="4" placeholder="" value="<?php echo $normal_rule[4]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($normal_rule[4]['to']) / 4 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                ...
                                                                <input type="text" class="form-control input-small-sc input-sm bg-white" readonly name="normal_chars[5][from]" placeholder="" value="<?php echo $normal_rule[5]['from'] ?>" />
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="normal_chars[5][to]" data-count="5" placeholder="" value="<?php echo $normal_rule[5]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($normal_rule[5]['to']) / 5 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                ...
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="unicode_chars[1][to]" data-count="1" placeholder="e.g. 70" value="<?php echo $unicode_rule[1]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($unicode_rule[1]['to']) / 1 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                <span class="input-group-addon">
                                                                    2 sms &nbsp;<i class="fa fa-arrow-right"></i> </span>
                                                                <input type="text" class="form-control input-small-sc input-sm bg-white" readonly name="unicode_chars[2][from]" placeholder="" value="<?php echo $unicode_rule[2]['from'] ?>" />
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="unicode_chars[2][to]" data-count="2" placeholder="" value="<?php echo $unicode_rule[2]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($unicode_rule[2]['to']) / 2 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                <span class="input-group-addon">
                                                                    3 sms &nbsp;<i class="fa fa-arrow-right"></i> </span>
                                                                <input type="text" class="form-control input-small-sc input-sm bg-white" readonly name="unicode_chars[3][from]" placeholder="" value="<?php echo $unicode_rule[3]['from'] ?>" />
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="unicode_chars[3][to]" data-count="3" placeholder="" value="<?php echo $unicode_rule[3]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($unicode_rule[3]['to']) / 3 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                <span class="input-group-addon">
                                                                    4 sms &nbsp;<i class="fa fa-arrow-right"></i> </span>
                                                                <input type="text" class="form-control input-small-sc input-sm bg-white" readonly name="unicode_chars[4][from]" placeholder="" value="<?php echo $unicode_rule[4]['from'] ?>" />
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="unicode_chars[4][to]" data-count="4" placeholder="" value="<?php echo $unicode_rule[4]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($unicode_rule[4]['to']) / 4 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group col-md-6 pull-left">
                                                                <span class="input-group-addon">
                                                                    5 sms &nbsp;<i class="fa fa-arrow-right"></i> </span>
                                                                <input type="text" class="form-control input-small-sc input-sm bg-white" readonly name="unicode_chars[5][from]" placeholder="" value="<?php echo $unicode_rule[5]['from'] ?>" />
                                                                <span class="input-group-addon">
                                                                    to </span>
                                                                <input type="text" class="form-control input-small-sc input-sm rangeto" name="unicode_chars[5][to]" data-count="5" placeholder="" value="<?php echo $unicode_rule[5]['to'] ?>" />
                                                                <span class="input-group-addon">
                                                                    chars</span>
                                                            </div>
                                                            <div class="col-md-2 pull-right rulerate">
                                                                <span class="label label-info"><?php echo intval($unicode_rule[5]['to']) / 5 ?> chars/sms</span>
                                                            </div>
                                                            <div class="clearfix"></div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="spclBox col-md-4">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control input-sm input-small-sc" name="signs[`]" value="<?php echo $spcl_rule['vals']["`"] ?>" /><span class="input-group-addon">char(s)</span>
                                                                </div>
                                                            ...
                                                            <div class="spclBox col-md-4">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control input-sm input-small-sc" name="signs[_]" value="<?php echo $spcl_rule['vals']["_"] ?>" /><span class="input-group-addon">char(s)</span>
                                                                </div>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control input-sm input-small-sc" name="signs[clb]" value="<?php echo $spcl_rule['vals']["]"] ?>" /><span class="input-group-addon">char(s)</span>
                                                                </div>
                                                                <div class="input-group">
                                                            ...
                                                            <div class="spclBox col-md-4">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control input-sm input-small-sc" name="signs[\]" value="<?php echo $spcl_rule['vals'][trim(" \ ")] ?>" /><span class="input-group-addon">char(s)</span>
                                                                </div>
