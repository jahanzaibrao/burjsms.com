                 ...
                 <div class="col-md-12">
                     <div class="widget p-lg">
                         <div class="row no-gutter">
                             <h3 class="page-title-sc"><?php echo SCTEXT('Add New HLR Channel') ?><small><?php echo SCTEXT('create a new channel for HLR Lookups') ?></small></h3>
                             <hr>
                             ...
                             <div class="col-md-12">
                                 ...
                                 <form class="form-horizontal" action="" method="post" id="hlrcfrm">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-md-8">
                                             <input type="text" class="form-control" name="chname" placeholder="enter the name to identify this HLR channel . . . .">
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         ...
                                         <div class="col-md-8">
                                             <select id="prsel" data-plugin="select2" class="form-control" name="provider" data-options="{placeholder: 'select HLR API provider . . .'}">
                                                 ...
                                                 <?php foreach ($data['providers'] as $pr) { ?>
                                                     <option data-async="<?php echo $pr['method'] ?>" data-website="<?php echo $pr['website'] ?>" data-method="<?php echo $pr['auth']['method'] ?>" value="<?php echo $pr['id'] ?>"><?php echo $pr['name'] ?></option>
                                                 <?php } ?>
                                             </select>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <div class="col-md-8">
                                             <div class="col-md-6 clearfix p-sm planopts text-dark" id="apiparam_getpost">
                                                 <input class="form-control block m-h-md" name="param1" value="" placeholder="enter API Key. . .">
                                             </div>
                                             <div class="col-md-6 clearfix p-sm planopts text-dark hidden" id="apiparam_httpauth">
                                                 <input class="form-control block m-h-md" name="param3" value="" placeholder="enter API key . . .">
                                             </div>
                                         </div>
                                     </div>
