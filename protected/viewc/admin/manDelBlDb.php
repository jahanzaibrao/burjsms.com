                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                <h3 class="page-title-sc"><?php echo SCTEXT('Delete Numbers')?><small><?php echo SCTEXT('delete a few mobile numbers from the blacklist database')?></small></h3>
                                <hr>
                                <?php include('notification.php') ?>
                                <div class="col-md-12">
                                <!-- start content -->
                                    <form class="form-horizontal" method="post" id="mandel_form"> 
                                        ...
                                        <hr>
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-8">
													<button class="btn btn-primary" id="save_changes" type="button"><?php echo SCTEXT('Delete Numbers')?></button>
