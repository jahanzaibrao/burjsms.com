                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                <h3 class="page-title-sc"><?php echo SCTEXT('Add Permission Group') ?><small><?php echo SCTEXT('add a new group of user permissions') ?></small></h3>
                                <hr>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="form-horizontal" method="post" id="upermgrp_form" action="">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="pgname" id="pgname" class="form-control" placeholder="<?php echo SCTEXT('enter permission group name') ?>..." maxlength="100" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Description:</label>
                                            <div class="col-md-8">
                                                <textarea name="pdesc" placeholder="give a brief details of assigned permissions etc. ." class="form-control"></textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-8 uperms">
                                                    ...
                                                    <div class="widget">
                                                        ...
                                                        <div class="widget-body">
                                                            <?php foreach ($data['refunds'] as $ref) { ?>
                                                                <div class="checkbox checkbox-primary">
                                                                    <input id="ref_<?php echo $ref->id ?>" name="perms[refunds][<?php echo $ref->id ?>]" checked="checked" type="checkbox">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="widget">
                                                        ...
                                                        <div class="widget-body">
                                                            <div class="checkbox checkbox-primary">
                                                                <input id="res_mon" name="perms[reseller][user_monitor]" checked="checked" type="checkbox">
                                                                <label for="res_mon"><?php echo SCTEXT('System Monitor') ?></label>
                                                            </div>
                                                            <div class="checkbox checkbox-primary">
                                                                <input id="res_wl" name="perms[reseller][whitelabel]" checked="checked" type="checkbox">
                                                                <label for="res_wl"><?php echo SCTEXT('Whitelabel Website') ?></label>
                                                            </div>
                                                            <div class="checkbox checkbox-primary">
                                                                <input id="tgw_plugin" name="perms[reseller][tgw_plugin]" checked="checked" type="checkbox">
