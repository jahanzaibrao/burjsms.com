                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                <h3 class="page-title-sc"><?php echo SCTEXT('Add New API')?><small><?php echo SCTEXT('add new API as a vendor similar to SMPP providers')?></small></h3>
                                <hr>
                                <div class="col-md-12">
                                <!-- start content -->
										...
										<div class="block">
                                            ...
                                            <div class="col-md-6">
												<div class="form-group">
												    ...
												    <div class="col-md-8">
													<input type="text" name="title" id="vapi_title" class="form-control" placeholder="<?php echo SCTEXT('enter a title for this API based channel')?>" />
												    </div>
											     </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
													...
													<label class="control-label col-md-3"><?php echo SCTEXT('Account SID')?>:</label>
														<div class="col-md-8">
														<input type="text" name="authsid" id="authsid" class="form-control" placeholder="<?php echo SCTEXT('enter the SID from your twillio account')?>" />
														</div>
													</div>
													<div class="form-group">
													<label class="control-label col-md-3"><?php echo SCTEXT('Auth Token')?>:</label>
														<div class="col-md-8">
														<input type="text" name="authtoken" id="authtoken" class="form-control" placeholder="<?php echo SCTEXT('enter the Auth token from your twillio account')?>" />
														</div>
													</div>
