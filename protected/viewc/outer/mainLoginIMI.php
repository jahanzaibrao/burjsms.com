...
<body class="simple-page warning" style="background-image: url('/global/img/imi.jpg');background-repeat: no-repeat;background-size:cover; background-color: #492e51;">
    ...
    <div id="tp-mainbox" class="simple-page-wrap text-dark">
        ...
        <div class="simple-page-form animated flipInY" id="login-form" style="background: rgba(255, 255, 255, 0.40);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(2px);-webkit-backdrop-filter: blur(9.8px);border: 1px solid rgba(255, 255, 255, 0.3);">
