...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway:400,500,600,700,800,900,300"> -->
    ...
    <style>
        ...
        <?php } ?>.simple-page-form .form-group {
...
<body class="simple-page warning" style="background-image: url('/global/img/wall/6752152.png');background-size: cover;background-color: #417b8e;">
    <div id="back-to-home"><a href="<?php echo Doo::conf()->APP_URL ?>" class="btn btn-warning"><i id="bthome" class="fa fa-home fa-2x animated zoomIn text-white"></i></a></div>
    <div class="simple-page-wrap text-dark" id="tp-mainbox" style="max-width:<?php echo $data['pflag'] == 0 && $data['mode'] != 'paypal' ? '500px' : '900px'; ?> !important">

        <div class="simple-page-form animated flipInY" id="reg-form" style="background: rgba(255, 255, 255, 0.46);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(9.8px);-webkit-backdrop-filter: blur(9.8px);border: 1px solid rgba(255, 255, 255, 0.3);">
            ...
            ?>
                ...
                <hr>
                <div id="optional-gs">
                    <div align="center"> <?php echo SCTEXT('OR') ?> </div>
                    <h4 align="center"><?php echo SCTEXT('Signup with your details') ?></h4>
                    <hr>
                </div>
                ...
                <form method="post" id="regform" action="">
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                <div class="input-group ">
                                    <select class="form-select" id="coverages" style="border: 1px solid white; background: none;">
                    ...
                    <input type="button" data-action='submit' class="btn btn-warning text-inverse" id="signup-submit" value="<?php echo SCTEXT('Create My Account') ?>">

                </form>
            <?php } ?>
            <?php if (Doo::conf()->whatsapp == 11) { ?>
                <hr>
