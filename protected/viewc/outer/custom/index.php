<?php include 'custom/inc/config.php'; ?>
<?php include 'custom/inc/template_start.php'; ?>
<?php include 'custom/inc/page_head.php'; ?>
            ...
            <section class="site-section site-section-light site-section-top themed-background-default">
                <div class="container">
                    ...
                    <p class="text-center animation-fadeIn">
                        <img src="custom/img/placeholders/screenshots/promo_desktop_left.png" alt="Promo Image 1">
                    </p>
                </div>
            </section>
        </div>
            ...
            <section class="site-section site-section-light site-section-top themed-background-fire">
                <div class="container">
                    ...
                    <p class="text-center animation-fadeInLeft">
                        <img src="custom/img/placeholders/screenshots/promo_desktop_right.png" alt="Promo Image 2">
                    </p>
                </div>
            </section>
        </div>
            ...
            <section class="site-section site-section-light site-section-top themed-background-amethyst">
                <div class="container">
                    ...
                    <p class="text-center animation-hatch">
                        <img src="custom/img/placeholders/screenshots/promo_mobile.png" alt="Promo Image 3">
                    </p>
                </div>
            </section>
        </div>
            ...
            <section class="site-section site-section-light site-section-top themed-background-modern">
                <div class="container">
                    ...
                    <p class="text-center animation-fadeIn360">
                        <img src="custom/img/placeholders/screenshots/promo_tablet.png" alt="Promo Image 4">
                    </p>
                </div>
            </section>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-180">
                <img src="custom/img/placeholders/screenshots/promo_desktop_left.png" alt="Promo #1" class="img-responsive">
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                <img src="custom/img/placeholders/screenshots/promo_desktop_right.png" alt="Promo #2" class="img-responsive">
            </div>
        </div>
        <hr>
    </div>
...
<section class="site-content site-section site-slide-content">
    <div class="container">
        <div class="row">
            <div class="col-sm-6 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInRight" data-element-offset="-180">
                <img src="custom/img/placeholders/screenshots/promo_tablet.png" alt="Promo #3" class="img-responsive">
            </div>
            <div class="col-sm-6 col-md-5 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
...
<section class="site-content site-section site-slide-content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-offset-1 site-block visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInLeft" data-element-offset="-180">
                <img src="custom/img/placeholders/screenshots/promo_mobile.png" alt="Promo #4" class="img-responsive">
            </div>
        </div>
        <hr>
    </div>
    ...
    <div class="container">
        ...
        <div id="testimonials-carousel" class="carousel slide carousel-html" data-ride="carousel" data-interval="4000">
            ...
            <div class="carousel-inner text-center">
                <div class="active item">
                    <p>
                        <img src="custom/img/placeholders/avatars/avatar12.jpg" alt="Avatar" class="img-circle">
                    </p>
                ...
                <div class="item">
                    <p>
                        <img src="custom/img/placeholders/avatars/avatar7.jpg" alt="Avatar" class="img-circle">
                    </p>
                    <blockquote class="no-symbol">
                ...
                <div class="item">
                    <p>
                        <img src="custom/img/placeholders/avatars/avatar9.jpg" alt="Avatar" class="img-circle">
                    </p>
                    <blockquote class="no-symbol">
...
<section class="site-content site-section themed-background">
    <div class="container">
        <!-- Stats Row -->
        <!-- CountTo (initialized in custom/js/app.js), for more examples you can check out https://github.com/mhuggins/jquery-countTo -->
...
<?php include 'custom/inc/page_footer.php'; ?>
<?php include 'custom/inc/template_scripts.php'; ?>
<?php include 'custom/inc/template_end.php'; ?>