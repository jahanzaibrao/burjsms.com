...
<body class="simple-page warning" style="background-image: url('/global/img/wall/6752152.png');background-size: cover; background-color: #417b8e;">
    ...
    <div id="tp-mainbox" class="simple-page-wrap text-dark">
        ...
        <div class="simple-page-form animated flipInY" id="login-form" style="background: rgba(255, 255, 255, 0.46);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(9.8px);-webkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 0.3);">
            ...
            <hr class="m-h-sm">
            <div class="simple-page-footer m-t-lg" style="font-weight: 800 !important;">
                ...
                <?php if ($pdata['regflag'] == '1') { ?>
                    <p><small><?php echo SCTEXT("Don't have an account") ?>?</small> <br><a href="<?php echo Doo::conf()->APP_URL ?>web/sign-up"><?php echo SCTEXT('CREATE AN ACCOUNT') ?></a></p>
                <?php } ?>
            </div>
        </div>
