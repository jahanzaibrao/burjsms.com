                ...
                <div class="col-md-12">
                    <div class="widget p-lg">
                        <div class="row no-gutter">
                            <h3 class="page-title-sc clearfix"><?php echo SCTEXT('Send MMS') ?><small><?php echo SCTEXT('compose multimedia campaign and send or schedule it') ?></small>
                            ...
                            <!-- start content -->
                            <form class="form-horizontal" method="post" id="sendsms_form" data-plugin="dropzone" data-options="{ url: '<?php echo Doo::conf()->APP_URL ?>globalFileUpload', previewsContainer:'.dropzone', maxFiles:10, acceptedFiles:'.jpg,.png,.jpeg,.wav,.mp3,.3gp,.mp4,.vcf,.pdf,.txt', addRemoveLinks:true, params:{mode:'sendmms'}, success: function(file,res){createInputFile('sendsms_form',res,'sendmms'); $('#uprocess').val('0');}, processing: function(file){$('#uprocess').val('1');}, canceled: function(file){$('#uprocess').val('0');}, removedfile: function(file){if(file.xhr) deleteInputFile(file.xhr.response,'sendmms');var _ref; return (_ref = file.previewElement) != null ? _ref.parentNode.removeChild(file.previewElement) : void 0;}}">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3"><?php echo SCTEXT('MMS Gateway') ?>:</label>
                                            <div class="col-md-8">
                                                <select class="form-control" name="mmsc" id="mmscsel" data-plugin="select2" data-options="{theme:'default'}">
                                                    <option data-stype="2" data-smax="11" data-sdef="MMSWEB" data-tflag="0" selected value="1">Primary MMSC</option>

                                                </select>
                                                <span class="help-block clearfix text-info m-b-0"><?php echo SCTEXT('Available Credits') ?>: <b id="rtavcr">999,999</b>
                                                    <span id="rtstatus" style="float: right;">
                                                        <span class="label label-success"><i class="fa fa-lg fa-check-circle"></i> &nbsp; active</span>
                                                    </span>
                                                </span>
                                        ...
                                        <div id="sidopnbox" class="form-group hidden">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <span class="help-block text-info m-b-0"><?php echo SCTEXT('Follow the rules for Sender ID set by your MMS provider.') ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div id="contactMainContainer" class="form-group">
                                            <label class="control-label col-md-3"><?php echo SCTEXT('Recipient(s):') ?>:</label>

                                            <?php if (sizeof($data['pbdata']) > 0) { ?>
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3"><?php echo SCTEXT('Add Media') ?>:</label>
                                            <div class="col-md-8 dropzone">
                                                <div class="dz-message">
                                                    <h3 class="m-h-lg"><?php echo SCTEXT('Drop Media files here for MMS.') ?></h3>
                                                    <p class="m-b-lg"> Supported: <br> <b>Image (jpg/png), </b><b>Audio (mp3/wav), </b><b>Video (3gp/mp4), </b><b>PDF, </b><b>Contact (vcf) </b></p>
                                                </div>
                                ...
                                <div class="col-md-12" style="padding-top: 40px; margin-top: 30px; box-shadow: 0px 2px 10px 0 hsl(0, 0%, 53%);">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">From (optional):</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="your_address@host or +3410010010 ...">
                                        </div>
                                        </label>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="enter the subject line for the message ...">
                                        </div>
                                        </label>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3"><?php echo SCTEXT('Message Content') ?>:</label>
                                        <div class="col-md-8">
                                            <div id="sms_content_box" class="">
                                                <div>
                                                    ...
                                                    <textarea placeholder="enter text to go along with the attached media files ..." id="text_sms_content" name="smstextcontent" rows="4" cols="50" maxlength="720" class="pop-over form-control m-b-sm" data-plugin="maxlength" data-options="{ alwaysShow: true, warningClass: 'label label-md label-info', limitReachedClass: 'label label-md label-danger', placement: 'bottom', message: 'used %charsTyped% of %charsTotal% chars.' }"></textarea>
                                                </div>
                                    ...
                                    <div class="form-group m-t-lg">
                                        ...
                                        <div class="col-md-8">
                                            <a class="btn btn-primary m-t-sm" id="submitsms" href="javascript:void(0);"><i class="fa fa-lg fa-check"></i>&nbsp;&nbsp; <?php echo SCTEXT('Send MMS Campaign') ?></a>
                                            <button id="smsprev" type="button" class="btn btn-default m-l-sm m-t-sm"><i class="fa fa-lg fa-search"></i>&nbsp;&nbsp; <?php echo SCTEXT('Preview MMS') ?></button>
                                        </div>
                                    </div>
                                </div>
