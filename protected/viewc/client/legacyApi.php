                ...
                <div class="col-md-12">
                    <div class="widget p-lg">
                        <div class="row no-gutter">
                            <h3 class="page-title-sc">Legacy Messaging API<small><?php echo SCTEXT('older API for backward compatibility') ?></small></h3>
                            <hr>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="tabbable">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="#tab2" data-toggle="tab">XML API</a></li>
                                    </ul>
                                    ...
                                    <div id="apitabctr" class="tab-content p-v-lg">
                                        ...
                                        <div class="tab-pane active fade in" id="tab1"><br><br>
                                            ...
                                            <div class="clearfix">
                                                <div class="col-md-6">
                                                    <div class="formSep"><span class="label label-info">API Url (GET and POST)</span> <span class="label label-success">HTTP SMS API</span>
                                                ...
                                                <div style="text-align:right" class="col-md-6 bg-warning text-dark">Your API Key is: <strong><?php echo $data['apikey'] ?> </strong>&nbsp;<button class="btn-primary btn">Regenerate Key</button>
                                                </div>
                                            ...
                                            <div class="m-t-xs clearfix">
                                                <div class="col-md-5 rescroll">
                                                    ...
                                                    <table class=" table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><kbd class="bg-primary">key=</kbd></td>
                                                                <td>API Key<br><span class="text-danger code">(required)</span></td>
                                                                <td>Your API Key (<?php echo $data['apikey'] ?>)</td>
                                                            </tr>

                                                            <tr>
                                                                <td><kbd class="bg-primary">&amp;campaign=</kbd></td>
                                                                <td> as defined in description<br><span class="text-primary code">(optional)</span></td>
                                                                <td>
                                                                    Enter ID of campaign as shown below. You can use 0 (zero) for the default campaign. <div style="max-width: 200px;">
                                                            ...
                                                            <tr>
                                                                <td><kbd class="bg-primary">&amp;routeid=</kbd></td>
                                                                <td>ID of the route as defined in description<br><span class="text-danger code">(required)</span></td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td><kbd class="bg-primary">&amp;type=</kbd></td>
                                                                <td>SMS Type<br><span class="text-primary code">(optional)</span></td>
                                                                <td>Leave this as <b>text</b></td>
                                                            </tr>

                                                            <tr>
                                                                <td><kbd class="bg-primary">&amp;contacts=</kbd></td>
                                                                <td>Contact Numbers<br><span class="text-danger code">(required)</span></td>
                                                                <td>Contact numbers separated by ' , ' (comma) sign<br>e.g. 9887XXXXXX,9567XXXXXX</td>
                                                            </tr>

                                                            <tr>
                                                                <td><kbd class="bg-primary">&amp;senderid=</kbd></td>
                                                                <td>Sender ID<br><span class="text-danger code">(required)</span></td>
                                                                <td>Any Approved Sender ID</td>
                                                            </tr>

                                                            <tr>
                                                                <td><kbd class="bg-primary">&amp;msg=</kbd></td>
                                                                <td>SMS Text<br><span class="text-danger code">(required)</span></td>
                                                                <td>Url-encoded SMS text. Must be limited to 720 characters</td>
                                                            </tr>

                                                            <tr>
                                                                <td><kbd class="bg-primary">&amp;time=</kbd></td>
                                                                <td>Schedule Time<br><span class="text-primary code">(optional)</span></td>
                                                                <td>Enter the time in the format YYYY-MM-DD H:I e.g. enter 2013-03-19 14:30 for 19th March 2013, 2:30 pm. Leave BLANK to send the SMS instantly.</td>
                                                            </tr>

                                                            <tr>
                                                                <td><kbd class="bg-primary">&amp;dlr_url=</kbd></td>
                                                                <td>Optional URL to post DLR<br><span class="text-primary code">(optional)</span></td>
                                                                <td>You can provide a URL where our system will post delivery reports.</td>
                                                            </tr>
                                                    ...
                                                    <!----- RESPONSES -------->
                                                    <h4 style="margin-top:15px;" class="page-header">Responses</h4>
                                                    <table class=" table table-striped table-bordered">
                                                        <thead>
                                                            <tr>
                                                                <th>API Response</th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>An error occurred while submitting the API call request. The source of error would be explained in the braces {}, for instance, "ERR: INVALID API KEY" means the API key entered is expired or does not belong to any user. The error messages are not ciphered and pretty much intuitive.</td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <code style="white-space:normal;border:none;">
                                                                ...
                                                                <td>This means SMS was submitted successfully, and it returns the shoot-id of the submission. You could use this ID to pull out delivery reports. The ID starts after the slash (/) mark.</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                ...
                                                <div class="p-l-xs col-md-7 rescroll">
                                                    ...
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            <tr>
                                                                <td><strong>Sample URL &amp; Sample API Codes</strong></td>
                                                            </tr>

                                                            <tr>
                                                                <td style="position:relative;">
                                                                    <span class="label label-info" style="position:absolute">Simple SMS</span>
                                                                    <div class="well">

                                                                        <code style="white-space:normal;border:none;">
                                                                            $api_url = "<?php echo $data['baseurl'] ?>smsapi/index?key=<?php echo $data['apikey'] ?>&amp;campaign=0&amp;routeid=14&amp;type=text&amp;contacts=97656XXXXX,98012XXXXX&amp;senderid=DEMO&amp;msg=Hello+People%2C+have+a+great+day";
                                                                        </code>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="position:relative;">
                                                                    <span class="label label-info" style="position:absolute">Scheduled SMS</span>
                                                                    <div class="well">
                                                                        <code style="white-space:normal;border:none;">
                                                                            $api_url = "<?php echo $data['baseurl'] ?>smsapi/index?key=<?php echo $data['apikey'] ?>&amp;campaign=1&amp;routeid=14&amp;type=text&amp;contacts=97656XXXXX,98012XXXXX&amp;senderid=DEMO&amp;msg=Hello+People%2C+have+a+great+day&amp;time=2024-09-12+09%3A58";
                                                                        </code>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td style="position:relative;">
                                                                    <span class="label label-info" style="position:absolute"> HTTP GET Sample Code (PHP)</span>
                                                                    <div class="well">
                                                                        <code style="white-space:normal;border:none;">
                                                                            &lt;?php
                                                                            ...
                                                                            <p class="text-info">
                                                                                ...
                                                                                $contacts = '9197656XXXXX,9198012XXXXX';<br>
                                                                                $from = 'DEMO';<br>
                                                                                $sms_text = urlencode('Hello People, have a great day');<br><br>
                                                                                $api_url = "<?php echo $data['baseurl'] ?>smsapi/index?key=".<span class="text-error">$api_key</span>."&amp;campaign=0&amp;routeid=14&amp;type=text&amp;contacts=".<span class="text-error">$contacts</span>."&amp;senderid=".<span class="text-error">$from</span>."&amp;msg=".<span class="text-error">$sms_text</span>;
                                                                            </p>
                                                                            <p class="text-warning">//Submit to server</p>
                                                                            <p class="text-info">
                                                                                $response = file_get_contents( <span class="text-error">$api_url</span>);<br>
                                                                                echo $response;
                                                                            </p>
                                                                            ?&gt;
                                                                        </code>
                                                            ...
                                                            <tr>
                                                                <td style="position:relative;">
                                                                    <span class="label label-info" style="position:absolute"> HTTP POST Sample Code (PHP)</span>
                                                                    <div class="well">
                                                                        <code style="white-space:normal;border:none;">
                                                                            &lt;?php
                                                                            ...
                                                                            <p class="text-info">
                                                                                $api_key = '<?php echo $data['apikey'] ?>';<br>
                                                                                $contacts = '9197656XXXXX,9197612XXXXX,9176012XXXXX,9180012XXXXX,9189456XXXXX,9188010XXXXX,9198442XXXXX';<br>
                                                                                $from = 'DEMO';<br>
                                                                            ...
                                                                            <p class="text-info">
                                                                                ...
                                                                                curl_setopt($ch, CURLOPT_POSTFIELDS, "key=".<span class="text-error">$api_key</span>."&amp;campaign=0&amp;routeid=14&amp;type=text&amp;contacts=".<span class="text-error">$contacts</span>."&amp;senderid=".<span class="text-error">$from</span>."&amp;msg=".<span class="text-error">$sms_text</span>);<br>
                                        ...
                                        <div class="tab-pane fade" id="tab2"><br /><br />
                                            <div class="clearfix">
                                                <div class="col-md-6">
                                                    <div class="formSep"><span class="label label-info">API Url (GET and POST)</span> <span class="label label-success">XML SMS API</span>
                                                        <h4 class="m-t-sm page-header"><?php echo $data['baseurl'] ?>smsapi/index</h4>
                                                    ...
                                                    <table class=" table table-striped table-bordered ">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo SCTEXT('Leave this as') ?> <strong>text, flash or unicode</strong></td>
                                                            </tr>
