                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                <h3 class="page-title-sc"><?php echo SCTEXT('Add New Campaign')?><small><?php echo SCTEXT('add a new campaign with other parameters')?></small></h3>
                                <hr>
                                ...
                                <!-- start content -->
                                    ...
                                    <form class="form-horizontal" method="post" id="cmpn_form" action="">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="cname" id="cname" class="form-control" placeholder="<?php echo SCTEXT('enter title for this campaign')?>. . . ." maxlength="100" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <textarea class="form-control" placeholder="<?php echo SCTEXT('describe your campaign e.g. purpose or audience type for this campaign') ?>" name="cdesc"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <div class="p-sm panel m-b-0 bg-info">
                                                    <div>
                                                        <select class="form-control" name="pkeyword" id="pkeyword" data-plugin="select2" data-options="{templateResult: function (data){ if(!data.element){return ''}; if(data.element.value==0){return data.text;}else{ var nstr = '<div class=\'pull-left\'>'+data.text+'</div><div class=\'pull-right\'><span class=\'label label-primary\'>'+data.element.dataset.vmn+'</span></div><div class=\'clearfix\'></div>';return $(nstr);} }, templateSelection: function (data){ if(!data.element){return ''}; if(data.element.value==0){return data.text;}else{ var nstr = '<div class=\'pull-left\'>'+data.text+'</div><div class=\'pull-right\'><span class=\'label label-primary\'>'+data.element.dataset.vmn+'</span></div><div class=\'clearfix\'></div>';return $(nstr);} } }">
                                                            ...
                                                            <?php foreach($data['kws'] as $kw){ ?>
                                                                <option value="<?php echo $kw->id ?>" data-vmn="<?php echo $kw->vmn ?>"><?php echo $kw->keyword ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    ...
                                                    <div id="optset" class="row p-sm ">
                                                        <div class="col-md-6">
                                                            ...
                                                            <hr>
                                                            <input placeholder="e.g. YES, START, etc" data-plugin="tagsinput" name="optin_kws" class="form-control">
                                                        ...
                                                        <div class="col-md-6 p-l-sm">
                                                            ...
                                                            <hr>
                                                            <input placeholder="e.g. STOP, BLOCK, etc" data-plugin="tagsinput" name="optout_kws" class="form-control">
                                    ...
                                    <?php if($_SESSION['user']['account_type']=='0'){ ?>
                                        ...
                                        <div id="sidopnbox" class="form-group hidden">
                                            <label class="control-label col-md-3"><?php echo SCTEXT('Default Sender')?>:</label>
                                            <div class="col-md-8">
                                                <input type="text" name="defsender" id="senderopn" class="form-control" placeholder="<?php echo SCTEXT('enter sender ID')?>..." maxlength="50" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="radio radio-inline radio-primary">
                                                    <input id="def1" checked="checked" type="radio" name="isdef" value="0">
                                                    <label for="def1"><?php echo SCTEXT('No')?></label>
                                                </div>
                                                <div class="radio radio-inline radio-primary">
                                                    <input id="def2" type="radio" name="isdef" value="1">
