                    ...
                    <div class="widget p-lg">
                        <div class="row no-gutter">
                            ...
                            <form class="form-horizontal" method="post" id="sendsms_form" data-plugin="dropzone" data-options="{ url: '<?php echo Doo::conf()->APP_URL ?>globalFileUpload', previewsContainer:'.dropzone', maxFiles:1, acceptedFiles:'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/x-csv,application/vnd.ms-excel,text/plain,text/csv,.xls', addRemoveLinks:true, params:{mode:'sendsms'}, success: function(file,res){createInputFile('sendsms_form',res,'sendsms'); $('#uprocess').val('0'); $('.dz-message').addClass('hidden');}, processing: function(file){$('#uprocess').val('1');}, canceled: function(file){$('#uprocess').val('0');}, removedfile: function(file){if(file.xhr) deleteInputFile(file.xhr.response,'sendsms');$('.dz-message').removeClass('hidden');var _ref; return (_ref = file.previewElement) != null ? _ref.parentNode.removeChild(file.previewElement) : void 0;}}">
                                ...
                                <input type="hidden" name="def_sys_tz" id="def_sys_tz" value="<?php echo Doo::conf()->default_server_timezone ?>">
                                <div class="col-md-12">
                                    <div class="col-md-6">

                                        <?php if ($_SESSION['user']['account_type'] == '1') {
                                            //check if assigned plan has a single route, if yes show sender id based on route settings else show approval based as it is more restrictive: V9 has 1 route per plan now
                                                        ...
                                                        <div class="widget m-b-0 text-center">
                                                            <div class="m-b-0 nav-tabs-horizontal">
                                                                <ul class="nav nav-tabs" role="tablist">
                                                                    ...
                                                                    <?php if ($_SESSION['permissions']['master'] == '1' || isset($_SESSION['permissions']['messaging']['contacts'])) { ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div id="stype-main">
                                                    ...
                                                    <div class="radio radio-inline radio-primary">
                                                        <input name="smstype" id="wapsms" type="radio" value="wap" <?php if (!$_SESSION['permissions']['master'] && !$_SESSION['permissions']['messaging']['wap_push']) { ?> disabled <?php } ?>>
                                                        <label for="wapsms">WAP</label>
                                                    </div>
                                                    <div class="radio radio-inline radio-primary">
                                                        <input name="smstype" id="vcsms" type="radio" value="vcard" <?php if (!$_SESSION['permissions']['master'] && !$_SESSION['permissions']['messaging']['vcard_sms']) { ?> disabled <?php } ?>>
                                                ...
                                                <div id="stype-subopts">
                                                    <div class="checkbox checkbox-success checkbox-inline">
                                                        <input id="flashsms" name="flash-sel" type="checkbox" <?php if (!$_SESSION['permissions']['master'] && !$_SESSION['permissions']['messaging']['flash_sms']) { ?> disabled <?php } ?>>
                                                        <label for="flashsms">Flash</label>
                                                    </div>

                                                    <div class="checkbox checkbox-success checkbox-inline">
                                                        <input id="dynsms" name="dyn-sel" type="checkbox" <?php if (!$_SESSION['permissions']['master'] && !$_SESSION['permissions']['messaging']['personalized_sms']) { ?> disabled <?php } ?>>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div id="vcard_content_box" class="hidden">
                                                    <div class="input-group m-b-xs">
                                                        ...
                                                        <input id="vcard_fname" class="form-control" type="text" name="smstext[vcard_fname]" placeholder="<?php echo SCTEXT('Enter First Name') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-info"><i class="fa fa-user-plus fa-fw fa-lg text-white"></i></span>
                                                        <input id="vcard_lname" class="form-control" type="text" name="smstext[vcard_lname]" placeholder="<?php echo SCTEXT('Enter Last Name') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-warning"><i class="fa fa-building fa-fw fa-lg text-dark"></i></span>
                                                        <input id="vcard_comp" class="form-control" type="text" name="smstext[vcard_comp]" placeholder="<?php echo SCTEXT('Enter Company Name') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-danger"><i class="fa fa-briefcase fa-fw fa-lg text-white"></i></span>
                                                        <input id="vcard_job" class="form-control" type="text" name="smstext[vcard_job]" placeholder="<?php echo SCTEXT('Enter Job Title') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-success"><i class="fa fa-phone fa-fw fa-lg text-white"></i></span>
                                                        <input id="vcard_tel" class="form-control" type="text" name="smstext[vcard_tel]" placeholder="<?php echo SCTEXT('Enter Telephone No.') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-purple"><i class="fa fa-envelope fa-fw fa-lg text-white"></i></span>
                                                        <input id="vcard_email" class="form-control" type="text" name="smstext[vcard_email]" placeholder="<?php echo SCTEXT('Enter Email ID') ?>" />
                                                    </div>
                                                </div>
                                                <?php if (Doo::conf()->smd_sendsms_warning == 1) { ?>
                                                    <span class="help-block text-danger fz-sm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <?php if ($_SESSION['permissions']['master'] == '1' || isset($_SESSION['permissions']['messaging']['schedule'])) { ?>
                                                    <div class="radio radio-inline radio-primary">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body p-lg">
                                                <p><?php echo SCTEXT('Your campaign was successfully submitted to the server. All you need to do now is wait for the delivery reports.') ?></p>
