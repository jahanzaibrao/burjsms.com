                ...
                <div class="col-md-12">
                    <div class="widget p-lg">
                        <div class="row no-gutter">
                            <h3 class="page-title-sc clearfix"><?php echo SCTEXT('Send SMS') ?><small><?php echo SCTEXT('compose your SMS campaign and send or schedule it') ?></small>
                            ...
                            <form class="form-horizontal" method="post" id="sendsms_form" data-plugin="dropzone" data-options="{ url: '<?php echo Doo::conf()->APP_URL ?>globalFileUpload', previewsContainer:'.dropzone', maxFiles:1, acceptedFiles:'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,text/x-csv,application/vnd.ms-excel,text/plain,text/csv,.xls', addRemoveLinks:true, params:{mode:'sendsms'}, success: function(file,res){createInputFile('sendsms_form',res,'sendsms'); $('#uprocess').val('0'); $('.dz-message').addClass('hidden');}, processing: function(file){$('#uprocess').val('1');}, canceled: function(file){$('#uprocess').val('0');}, removedfile: function(file){if(file.xhr) deleteInputFile(file.xhr.response,'sendsms');$('.dz-message').removeClass('hidden');var _ref; return (_ref = file.previewElement) != null ? _ref.parentNode.removeChild(file.previewElement) : void 0;}}">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                            <input data-stype="<?php echo $rt['senderType'] ?>" data-smax="<?php echo $rt['maxSender'] ?>" data-sdef="<?php echo $rt['defaultSender'] ?>" data-tflag="<?php echo $rt['templateFlag'] ?>" data-actspan='<?php echo base64_decode($rt['activeTime']) ?>' data-cov="<?php echo $rt['coverage'] ?>" data-crule="<?php echo $rt['creditRule'] ?>" data-crval="<?php echo $rt['validity'] ?>" data-acr="<?php echo $rt['credits'] ?>" data-stop="<?php echo str_replace('"', "'", $rt['optout_config']) ?>" type="hidden" id="mccdefroute" value="<?php echo $rt['id'] ?>" name="route">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <?php if (Doo::conf()->smd_sendsms_warning == 1) { ?>
                                                        <span class="help-block text-danger fz-sm">
                                                            Please note that the TRA timing for sending SMS is from 7 AM till 9 PM .
                                                            SMS before or after the mentioned time can cause the suspension of Sender ID and a fine of 25,000 AED can be issued upon receiving complaint from Operators.
                                        ...
                                        <?php } else { ?>
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control" name="route" id="routesel" data-plugin="select2" data-options="{theme:'default'}">
                                                        <?php foreach ($data['routes'] as $rt) { ?>
                                                            <option data-stop="<?php echo str_replace('"', "'", $rt['optout_config']) ?>" data-stype="<?php echo $rt['senderType'] ?>" data-smax="<?php echo $rt['maxSender'] ?>" data-sdef="<?php echo $rt['defaultSender'] ?>" data-tflag="<?php echo $rt['templateFlag'] ?>" data-actspan='<?php echo base64_decode($rt['activeTime']) ?>' data-cov="<?php echo $rt['coverage'] ?>" data-crule="<?php echo $rt['creditRule'] ?>" data-crval="<?php echo $rt['validity'] ?>" data-acr="<?php echo $rt['credits'] ?>" data-rate="<?php echo $rt['price'] ?>" data-tlvs="<?php echo $rt['tlv_ids'] ?>" <?php if ($rt['id'] == $_SESSION['settings']['def_route']) { ?> selected <?php } ?> value="<?php echo $rt['id'] ?>"><?php echo $rt['name'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                            ...
                                            <div id="sidselbox" class="form-group hidden">
                                                <label class="control-label col-md-3"><?php echo SCTEXT('Choose Sender') ?>:</label>
                                                <div class="col-md-8">
                                                    <select class="form-control" name="sendersel" id="sendersel" data-plugin="select2">
                                                        <?php foreach ($data['sids'] as $sid) { ?>
                                                            <option value="<?php echo $sid->id ?>"><?php echo $sid->sender_id ?></option>
                                        ...
                                        <div id="contactMainContainer" class="form-group">
                                            ...
                                            <?php if (is_countable($data['pbdata']) && sizeof($data['pbdata']) > 0) { ?>

                                                <div class="col-md-8">
                                                    <?php if ($_SESSION['user']['account_type'] == '1') { ?>
                                                        <span class="help-block text-danger">Must include country prefix in contact numbers for proper routing e.g. 91 for India, 39 for Italy etc.</span>
                                                    <?php } ?>
                                                    <div id="">
                                                        <div class="radio radio-inline radio-primary">
                                                            <input name="contact-type" id="mycontact" checked type="radio" value="my">
                                                            <label for="mycontact"><?php echo SCTEXT('My Contacts') ?></label>
                                                        </div>

                                                        <div class="radio radio-inline radio-primary">
                                                            <input name="contact-type" id="syspb" type="radio" value="pb">
                                                            <label for="syspb"><?php echo SCTEXT('System Phonebook') ?></label>
                                                        </div>
                                                        ...
                                                        <div class="widget m-b-0 text-center">
                                                            <div class="m-b-0 nav-tabs-horizontal">
                                                                <ul class="nav nav-tabs" role="tablist">
                                                                    <li role="presentation" class="active"><a href="#tab-3" aria-controls="tab-3" role="tab" data-toggle="tab"><?php echo SCTEXT('Upload File') ?></a></li>
                                                                    <li role="presentation"><a href="#tab-2" aria-controls="tab-3" role="tab" data-toggle="tab"><?php echo SCTEXT('Contact Groups') ?></a></li>
                                                                    <li role="presentation"><a href="#tab-1" aria-controls="tab-1" role="tab" data-toggle="tab"><?php echo SCTEXT('Enter Numbers') ?></a></li>
                                                    ...
                                                    <div id="phonebookbox" style="display:none">
                                                        <div class="m-t-md col-md-12">
                                                            <table id="dt-pbdb-send" data-plugin="DataTable" data-options="{ order:[], drawCallback: function(s){$('.pbdbsel').attr('checked', false);calcContacts();}, lengthChange: false, pageLength: 5, language: { search: '', searchPlaceholder: 'Search...', url: '//cdn.datatables.net/plug-ins/1.10.20/i18n/<?php echo locale_get_display_language($_SESSION['APP_LANG']) ?>.json' }}" class="fz-sm wd100 table table-bordered table-striped">
                                                                <thead>
                                                                    <tr>
                                                                        <th><?php echo SCTEXT('Select') ?></th>
                                                                        <th><?php echo SCTEXT('Category') ?></th>
                                                                        <th><?php echo SCTEXT('Total Contacts') ?></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <?php foreach ($data['pbdata'] as $pbdb) { ?>
                                                                        <tr>
                                                                            <td>
                                                                                <div class="p-t-0 radio radio-primary">
                                                                                    <input data-count="<?php echo $pbdb->contact_count ?>" type="radio" id="pbopt<?php echo $pbdb->id ?>" name="pbdbsel" class="pbdbsel" value="<?php echo $pbdb->id ?>">
                                                                                    <label for="pbopt<?php echo $pbdb->id ?>"></label>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <?php echo $pbdb->group_name; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?php echo number_format($pbdb->contact_count); ?>
                                                                            </td>
                                                                        </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                            ...
                                                            <hr class="m-b-xs">
                                                            <h5><?php echo SCTEXT('Select Range') ?></h5>
                                                            <hr class="m-t-xs">
                                                            <div class="input-group"><input type="text" class="form-control input-small-sc-r input-sm bg-white" id="pbfrom" name="pbrange[from]" placeholder="e.g. 1" value=""><span class="input-group-addon"> to </span><input type="text" class="form-control input-small-sc-r input-sm rangeto" id="pbto" name="pbrange[to]" placeholder="e.g. 10000" value=""><span class="input-group-addon"><?php echo SCTEXT('Contacts') ?></span></div>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 clearfix">
                                                <span id="contcountbox" class="help-block text-danger m-b-0"><b id="conf_total_contacts">0</b> contact(s) X <b>1</b> SMS = <b id="conf_total_cost">0</b> <?php echo SCTEXT('credits required') ?> <span id="contcountloader" class="hidden pull-right text-dark"><i class="fa fa-lg fa-spin fa-circle-o-notch"></i> </span></span>
                                    ...
                                    <div class="col-md-6">
                                        <?php if (Doo::conf()->gvsms_plugin == true) { ?>
                                            <div class="form-group">
                                                <label class="control-label col-md-3"><?php echo SCTEXT('Verified SMS') ?>:</label>
                                                <div class="col-md-8">
                                                    <div class="checkbox checkbox-success">
                                                        <input id="toggle-vsms" name="tglvsms" class="toggle" type="checkbox" value="1">
                                                        <label for="toggle-vsms"><?php echo SCTEXT('Send as Verified By Google') ?> </label>
                                                    </div>
                                                    <div style="display: none;" id="vsms_agent_sel_box" class="m-t-md wd100">
                                                        <select name="vsms_agent" title="Select A Verified Agent" id="vsms_agent" class="form-control" data-plugin="select2" data-options="{templateResult: function (data){ if(data.element && data.element.value!=''){ let uname = data.element.text; var lstr = data.element.label; var myarr = lstr.split('|'); var nstr = '<div class=\'media m-t-xs\'><div class=\'media-left\'><div class=\'avatar avatar-xs avatar-circle\'><a href=\'javascript:void(0);\'><img src=\''+myarr[0]+'\'></a></div></div><div class=\'media-body\'><h5 class=\'m-t-0 m-b-0\'><a href=\'javascript:void(0);\' class=\'m-r-xs text-dark\'>'+uname+'</a><small class=\'text-muted fz-sm\'>'+myarr[2]+'</small></h5><p style=\'font-size: 12px;font-style: Italic; line-height:14px;\'>'+myarr[1]+'</p></div></div>';}else{var nstr='<h5>- Select Google Verified Agent -</h5>';} return $(nstr);}, templateSelection: function (data){ if(data.element.value=='') return '- Select Google Verified Agent -'; let uname = data.element.text; var lstr=data.element.label;var myarr = lstr.split('|'); var nstr = '<div class=\'media\' style=\'padding-top: 2px;\'><div class=\'media-left\'><div class=\'avatar avatar-xs avatar-circle\'><a href=\'javascript:void(0);\'><img src=\''+myarr[0]+'\'></a></div></div><div class=\'media-body\'><h5 class=\'m-t-0 m-b-0\'><a href=\'javascript:void(0);\' class=\'m-r-xs text-dark\'>'+uname+'</a><small class=\'text-muted fz-sm\'>'+myarr[2]+'</small></h5><p style=\'font-size: 12px;font-style: Italic;line-height:14px;\'>'+myarr[1]+'</p></div></div>'; return $(nstr);} }">
                                                            <option value="">- Select Google Verified Agent -</option>
                                                            <?php foreach ($data['vagents'] as $agent) { ?>
                                                                <option data-pkey="<?php echo $agent->public_key ?>" value="<?php echo $agent->id ?>" data-fullname="<?php echo $agent->agent_name ?>" label="<?php echo $agent->logo . '|' . $agent->agent_desc . '|' . "|" ?>"><?php echo $agent->agent_name ?></option>
                                                            <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div id="" class="panel p-sm bg-primary m-b-0 m-t-xs">
                                                    <?php if ($_SESSION['permissions']['wap'] == false && $_SESSION['permissions']['vcard'] == false) { ?>
                                                        <h5 class="m-h-xs"><?php echo SCTEXT('Text') ?> <span id="unicodebadge" class="hidden label label-md m-l-xs label-warning text-dark">Unicode</span></h5>
                                                        <input name="smstype" id="txtsms" checked type="radio" value="text" style="display: none;">
                                                    <?php } else { ?>
                                                        <div id="stype-main">
                                                            <div class="radio radio-inline radio-primary">
                                                                <input name="smstype" id="txtsms" checked type="radio" value="text">
                                                                <label for="txtsms">Text
                                                                    <span id="unicodebadge" class="hidden label label-md m-l-xs label-warning text-dark">Unicode</span></label>
                                                            </div>

                                                            <div class="radio radio-inline radio-primary">
                                                                <input name="smstype" id="wapsms" type="radio" value="wap" <?php if ($_SESSION['permissions']['wap'] != 'on') { ?> disabled <?php } ?>>
                                                                <label for="wapsms">WAP</label>
                                                            </div>
                                                            <div class="radio radio-inline radio-primary">
                                                                <input name="smstype" id="vcsms" type="radio" value="vcard" <?php if ($_SESSION['permissions']['vcard'] != 'on') { ?> disabled <?php } ?>>
                                                    ...
                                                    <div id="stype-subopts">
                                                        <div class="checkbox checkbox-success checkbox-inline">
                                                            <input id="flashsms" name="flash-sel" type="checkbox" <?php if ($_SESSION['permissions']['flash'] != 'on') { ?> disabled <?php } ?>>
                                                            <label for="flashsms">Flash</label>
                                                        </div>

                                                        <div class="checkbox checkbox-success checkbox-inline">
                                                            <input id="dynsms" name="dyn-sel" type="checkbox" <?php if ($_SESSION['permissions']['per'] != 'on') { ?> disabled <?php } ?>>
                                                ...
                                                <div style="display: none;">
                                                    ...
                                                    <div id="unicodetypebox" class="panel p-sm bg-primary m-b-0 m-t-xs">
                                                        <input type="hidden" name="unicodeFlag" id="unicodeFlag" value="0">
                                                    ...
                                                    <?php /*
                                                    <div class="checkbox checkbox-success checkbox-inline">
                                                        <input onclick="javascript:checkboxClickHandler()" id="unicodesms" name="unicode-sel" type="checkbox" <?php if ($_SESSION['permissions']['unicode'] != 'on') { ?> disabled <?php } ?>>
                                                ...
                                                <?php if (Doo::conf()->add_auto_stop_button == 1) { ?>
                                                    <span class="help-block m-b-0">
                                                        <hr>
                                                        <a id="stopmsg" href="javascript:void(0);" class="btn btn-xs btn-danger p-v-xs m-r-xs">Add STOP Message</a>
                                                    </span>
                                                <?php } ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-8">
                                                <div id="sms_content_box" class="">
                                                    <div>
                                                        ...
                                                        <textarea id="text_sms_content" name="smstextcontent" rows="9" cols="50" class="pop-over form-control"></textarea>
                                                    </div>
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="pull-right">
                                                            <a id="selMedia" title="Add Media Link" data-toggle="modal" data-target="#medbox" class="btn btn-xs btn-danger p-v-xs m-r-xs" href="javascript:void(0);"><i class="fas fa-images"></i></a>
                                                ...
                                                <div id="wap_content_box" class="m-t-xs p-l-sm hidden">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="smstext[wap_title]" placeholder="<?php echo SCTEXT('Enter WAP-Push Title') ?>" class="pop-over form-control" data-content="<?php echo SCTEXT('Title limits to 60 characters. Enter a brief phrase to describe WAP content.') ?>" data-trigger="hover" data-placement="top" maxlength="60" id="wap_sms_title" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="wap_sms_url">WAP URL</label>
                                                        <input type="text" name="smstext[wap_url]" maxlength="100" placeholder="<?php echo SCTEXT('Enter WAP-push URL') ?>" class="pop-over form-control" data-trigger="hover" data-content="<?php echo SCTEXT('URL must include protocol also e.g. http/wap. Must be limited to 100 characters.') ?>" data-placement="top" id="wap_sms_url" />
                                                    </div>
                                                </div>
                                                ...
                                                <div id="vcard_content_box" class="hidden">
                                                    <div class="input-group m-b-xs">
                                                        ...
                                                        <input class="form-control" type="text" name="smstext[vcard_fname]" placeholder="<?php echo SCTEXT('Enter First Name') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-info"><i class="fa fa-user-plus fa-fw fa-lg text-white"></i></span>
                                                        <input class="form-control" type="text" name="smstext[vcard_lname]" placeholder="<?php echo SCTEXT('Enter Last Name') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-warning"><i class="fa fa-building fa-fw fa-lg text-dark"></i></span>
                                                        <input class="form-control" type="text" name="smstext[vcard_comp]" placeholder="<?php echo SCTEXT('Enter Company Name') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-danger"><i class="fa fa-briefcase fa-fw fa-lg text-white"></i></span>
                                                        <input class="form-control" type="text" name="smstext[vcard_job]" placeholder="<?php echo SCTEXT('Enter Job Title') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-success"><i class="fa fa-phone fa-fw fa-lg text-white"></i></span>
                                                        <input class="form-control" type="text" name="smstext[vcard_tel]" placeholder="<?php echo SCTEXT('Enter Telephone No.') ?>" />
                                                    </div>
                                                    <div class="input-group m-b-xs">
                                                        <span class="input-group-addon bg-purple"><i class="fa fa-envelope fa-fw fa-lg text-white"></i></span>
                                                        <input class="form-control" type="text" name="smstext[vcard_email]" placeholder="<?php echo SCTEXT('Enter Email ID') ?>" />
                                                    </div>
                                                </div>
                                                <?php if (Doo::conf()->smd_sendsms_warning == 1) { ?>
                                                    <span class="help-block text-danger fz-sm">
                                                        (160 Characters are counted as 1 SMS in case of English language & 70 in other language. Check your SMS count before pushing SMS) Always Use <b><u class="fz-md">"unsub.ae"</u></b> in the end of your SMS content.
                                                    </span>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <?php if ($_SESSION['user']['account_type'] != "1") { ?>
                                                    <div class="radio radio-inline radio-primary">
                                                        <input name="sendnow" id="sbatch" type="radio" value="2">
                                                        <label for="sbatch"><?php echo SCTEXT('Smart Schedule') ?></label>
                                                    </div>
                                                <?php } ?>
                                                ...
                                                <div id="sbbox" class="help-block planopts text-dark p-sm m-t-md m-b-0" style="display: none;">

                                                    <div class="input-group m-b-sm">

                                                        <span class="input-group-addon"><?php echo SCTEXT('Batch size') ?></span>
                                                        <input id="sbsize" name="sbsize" type="number" min="0" class="form-control input-sm" placeholder="e.g. 5000">
                                                    </div>
                                                    <div class="input-group m-b-sm">
                                                        <span class="input-group-addon"><?php echo SCTEXT('Duration') ?></span>
                                                        <select id="sbduration" name="sbduration" class="form-control input-sm">
                                                            <option value="5"><?php echo SCTEXT('5 Minutes') ?></option>
                                                            <option value="10"><?php echo SCTEXT('10 Minutes') ?></option>
                                                            <option value="15"><?php echo SCTEXT('15 Minutes') ?></option>
                                                            <option value="20"><?php echo SCTEXT('20 Minutes') ?></option>
                                                            <option value="30"><?php echo SCTEXT('30 Minutes') ?></option>
                                                            <option value="60"><?php echo SCTEXT('60 Minutes') ?></option>
                                                            <option value="90"><?php echo SCTEXT('90 Minutes') ?></option>
                                                            <option value="120"><?php echo SCTEXT('2 Hours') ?></option>
                                                            <option value="180"><?php echo SCTEXT('3 Hours') ?></option>
                                                            <option value="360"><?php echo SCTEXT('6 Hours') ?></option>
                                                            <option value="720"><?php echo SCTEXT('12 Hours') ?></option>
                                                            <option value="1440"><?php echo SCTEXT('24 Hours') ?></option>
                                                            <option value="2880"><?php echo SCTEXT('48 Hours') ?></option>
                                                        </select>
                                                    </div>
                                                    <div class="input-group m-b-sm">
                                                        <span class="input-group-addon"><?php echo SCTEXT('Send During') ?></span>
                                                        <select id="sbdays" name="sbdays" class="form-control input-sm">
                                                            <option value="0" data-desc="every day"><?php echo SCTEXT('All Days') ?></option>
                                                            <option value="1" data-desc="from Monday to Friday"><?php echo SCTEXT('Monday to Friday') ?></option>
                                                            <option value="2" data-desc="only on weekends"><?php echo SCTEXT('Only Weekends') ?></option>
                                                        </select>
                                                    </div>
                                                    <span id="sbexp" class="help-block text-primary">
                                                        Send 5000 SMS every 60 Minutes every day starting </span>
                                                    <div class="radio radio-inline radio-primary">
                                                        <input checked name="lcstart" id="lcnow" type="radio" value="0">
                                                        <label for="lcnow">Now</label>
                                                    </div>
                                                    <div class="radio radio-inline radio-primary">
                                                        <input name="lcstart" id="lclater" type="radio" value="1">
                                                        <label for="lcnow">This Date/Time</label>
                                                    </div>
                                                    <div class="input-group m-t-sm">
                                                        <label for="lcdp" class="input-group-addon bg-info text-white"><i class="fa fa-lg fa-calendar"></i> </label>
                                                        <input type="text" id="lcdp" name="lctime" class="form-control input-sm">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group m-t-lg">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <a class="btn btn-primary m-t-sm" id="submitsms" href="javascript:void(0);"><i class="fa fa-lg fa-check"></i>&nbsp;&nbsp; <?php echo SCTEXT('Send SMS Campaign') ?></a>
