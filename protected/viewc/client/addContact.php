                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                <h3 class="page-title-sc"><?php echo SCTEXT('Add New Contact')?><small><?php echo SCTEXT('add a new contact in')?> <b><?php echo $data['gdata']->group_name ?></b></small></h3>
                                <hr>
                                    ...
                                    <form class="form-horizontal" method="post" id="ct_form" action="">
                                        ...
                                        <div class="form-group">
												<label class="control-label col-md-3"><?php echo SCTEXT('Contact number')?>:</label>
												    <div class="col-md-8">
													   <input type="tel" class="form-control" name="contactno" id="contactno" placeholder="<?php echo SCTEXT('enter mobile number')?> . . . ." />
												    </div>
										</div>
                                        <div class="form-group">
												<label class="control-label col-md-3"><?php echo SCTEXT('Name')?>:</label>
												    <div class="col-md-8">
													   <input type="text" class="form-control" name="cname" id="cname" placeholder="<?php echo SCTEXT('enter name associated with this contact')?> . . . ." />
												    </div>
										</div>
                                        ...
                                        <?php if($colar['varC']!=''){ ?>
                                            <div class="form-group">
												<label class="control-label col-md-3"><?php echo $colar['varC'] ?>:</label>
												    <div class="col-md-8">
													   <input type="text" class="form-control" name="varC" id="varC" placeholder="enter <?php echo $colar['varC'] ?> associated with this contact . . . ." />
												    </div>
										      </div>
                                        <?php } ?>
                                        <?php if($colar['varD']!=''){ ?>
                                            <div class="form-group">
												<label class="control-label col-md-3"><?php echo $colar['varD'] ?>:</label>
												    <div class="col-md-8">
													   <input type="text" class="form-control" name="varD" id="varD" placeholder="enter <?php echo $colar['varD'] ?> associated with this contact . . . ." />
												    </div>
										      </div>
                                        <?php } ?>
                                        <?php if($colar['varE']!=''){ ?>
                                            <div class="form-group">
												<label class="control-label col-md-3"><?php echo $colar['varE'] ?>:</label>
												    <div class="col-md-8">
													   <input type="text" class="form-control" name="varE" id="varE" placeholder="enter <?php echo $colar['varE'] ?> associated with this contact . . . ." />
												    </div>
										      </div>
                                        <?php } ?>
                                        <?php if($colar['varF']!=''){ ?>
                                            <div class="form-group">
												<label class="control-label col-md-3"><?php echo $colar['varF'] ?>:</label>
												    <div class="col-md-8">
													   <input type="text" class="form-control" name="varF" id="varF" placeholder="enter <?php echo $colar['varF'] ?> associated with this contact . . . ." />
												    </div>
										      </div>
                                        <?php } ?>
                                        <?php if($colar['varG']!=''){ ?>
                                            <div class="form-group">
												<label class="control-label col-md-3"><?php echo $colar['varG'] ?>:</label>
												    <div class="col-md-8">
													   <input type="text" class="form-control" name="varG" id="varG" placeholder="enter <?php echo $colar['varG'] ?> associated with this contact . . . ." />
												    </div>
										      </div>
                                        <?php } ?>
                                        ...
                                        <div class="form-group">
												<label class="control-label col-md-3"><?php echo SCTEXT('Network')?>:</label>
												    <div class="col-md-8">
													   <input type="text" class="form-control" name="cnet" id="cnet" placeholder="<?php echo SCTEXT('enter network operator for this contact')?> . . . ." />
                                        ...
                                        <div class="form-group">
												<label class="control-label col-md-3"><?php echo SCTEXT('Region')?>:</label>
												    <div class="col-md-8">
													   <input type="text" class="form-control" name="ccir" id="ccir" placeholder="<?php echo SCTEXT('enter network region for this contact')?> . . . ." />
