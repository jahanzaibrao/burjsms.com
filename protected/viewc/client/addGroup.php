                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                <h3 class="page-title-sc"><?php echo SCTEXT('Add New Group')?><small><?php echo SCTEXT('add a new group to aggregate contacts')?></small></h3>
                                <hr>
                                    ...
                                    <form class="form-horizontal" method="post" id="grp_form" action="">
                                        <div class="form-group">
												<label class="control-label col-md-3"><?php echo SCTEXT('Group Name')?>:</label>
												    <div class="col-md-8">
													<input type="text" name="gname" id="gname" class="form-control" placeholder="<?php echo SCTEXT('enter contact group name')?>. . . ." maxlength="100" />
													   ...
													   <span class="help-block text-info"><?php echo SCTEXT('Now you can add upto 5 custom fields for contacts. Each group can have separate labels for these custom fields. Leave empty if you do not wish to use any of them.')?></span>
                                                        ...
                                                        <table class="wd100 table table-responsive">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>varC</td>
                                                                    <td><input type="text" class="form-control" name="varC" placeholder="<?php echo SCTEXT('add label for custom field')?> . . ."></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>varD</td>
                                                                    <td><input type="text" class="form-control" name="varD" placeholder="<?php echo SCTEXT('add label for custom field')?> . . ."></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>varE</td>
                                                                    <td><input type="text" class="form-control" name="varE" placeholder="<?php echo SCTEXT('add label for custom field')?> . . ."></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>varF</td>
                                                                    <td><input type="text" class="form-control" name="varF" placeholder="<?php echo SCTEXT('add label for custom field')?> . . ."></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>varG</td>
                                                                    <td><input type="text" class="form-control" name="varG" placeholder="<?php echo SCTEXT('add label for custom field')?> . . ."></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
												    </div>
