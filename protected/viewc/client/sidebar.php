<aside id="menubar" class="menubar">
    ...
    <div class="menubar-scroll">
        <div class="menubar-scroll-inner">
            <ul class="app-menu">
                <?php if (Doo::conf()->allow_buy_sms == 1 && Doo::conf()->top_payment_button == 1) { ?>
                    <li class="bg-<?php echo $_SESSION['webfront']['intheme'] ?>"><a href="<?php echo Doo::conf()->APP_URL ?>purchaseCredits"><i class="menu-icon zmdi zmdi-money zmdi-hc-lg"></i> <span class="menu-text"><?php echo SCTEXT('Buy SMS Credits') ?></span> </a>
                    </li>
                <?php } ?>
