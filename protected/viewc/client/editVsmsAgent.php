                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                <h3 class="page-title-sc"><?php echo SCTEXT('Modify Verified-SMS Agent')?><small><?php echo SCTEXT('An agent is a conversational representation of a brand')?></small></h3>
                                <hr>
                                ...
                                <div class="alert alert-info alert-custom alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button><h4 class="alert-title">Please Note!</h4><p>Agent Name, description and Logo cannot be changed after it is <span class="m-l-xs label label-success">Approved</span></p></div>
                                    ...
                                    <input type="hidden" id="oldlogo" data-path="" data-size="" value="<?php echo $data['vagent']->logo ?>" />
                                    <input type="hidden" name="vagentid" value="<?php echo $data['vagent']->id ?>">
                                    <div class="form-group">
                                        <label class="control-label col-md-3"><?php echo SCTEXT('Select Country')?>:</label>
                                            <div class="col-md-8">
                                                <select id="cov" name="cov" class="form-control" data-plugin="select2">
                                                    ...
                                                    <option <?php if($data['vagent']->country==$cv->country_code){ ?> selected="selected" <?php } ?>  value="<?php echo $cv->country_code ?>"><?php echo $cv->country ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input maxlength="100" class="form-control" name="vsms_aname" id="vsms_aname" placeholder="e.g. ABC Solutions LTD" value="<?php echo $data['vagent']->agent_name ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Description</label>
                                            <div class="col-md-8">
                                                <textarea maxlength="100" class="form-control" name="vsms_adesc" id="vsms_adesc" placeholder="e.g. ABC Solutions LTD provides useful services for your needs"><?php echo $data['vagent']->agent_desc ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Display Email</label>
                                            <div class="col-md-8">
                                                <input class="form-control" name="vsms_email" id="vsms_email" placeholder="e.g. contact@company-name.com" value="<?php echo $data['vagent']->brand_user_email ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Website</label>
                                            <div class="col-md-8">
                                                <input class="form-control" name="vsms_domain" id="vsms_domain" placeholder="e.g. https://your-site.com" value="<?php echo $data['vagent']->brand_user_website ?>">
                                        ...
                                        <?php $senders = json_decode($data['vagent']->sender_id_list, true); ?>
                                        <?php $senpre = json_decode($data['vagent']->sender_prefixes, true); ?>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <?php foreach($data['sids'] as $sid){ ?>
                                                    <option <?php if(in_array($sid->sender_id,$senders)){ ?> selected <?php } ?> value="<?php echo $sid->sender_id ?>"><?php echo $sid->sender_id ?></option>
                                                <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input placeholder="e.g. ID, VM, etc" data-plugin="tagsinput" name="vsms_sidpre" class="form-control" value="<?php echo implode(",",$senpre) ?>">
