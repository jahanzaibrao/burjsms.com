        ...
        <tr>
          <td class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff; padding-left: 30px; padding-right: 30px; font-size: 14px; line-height: 20px; font-family: Helvetica, sans-serif; color: #333;">
            ...
            Dear <?php echo $data['name'] ?>,
              ...
              Your payment via Paypal was successful. Here is the summary of your transaction.
            <br><br>
			<table width="200" border="0">
                 <tr>
    <td><strong>Payment Status</strong></td>
    <td><span style="font-size:22px;letter-spacing:2px;"><?php echo $data['payment_status'] ?></span></td>
  </tr>
  <tr>
    <td><strong>Amount Paid</strong></td>
    <td><span><?php echo $data['amount_paid'] ?></span></td>
  </tr>
                
                 <tr>
    <td><strong>Invoice ID</strong></td>
    <td><span><?php echo $data['invoice_id'] ?></span></td>
  </tr>
                 <tr>
    <td><strong>Paypal Transaction ID</strong></td>
    <td><span><?php echo $data['paypal_txnid'] ?></span></td>
  </tr>
                 <tr>
    <td><strong>Payer Email</strong></td>
    <td><span><?php echo $data['payer'] ?></span></td>
  </tr>
                
</table><br>
Thank you for your order. Please feel free to contact us in case you have any questions.<br><br>
            <!-- ### END CONTENT ### -->
