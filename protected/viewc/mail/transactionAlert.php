...
your account manager has performed a <?php echo $data['txntype'] ?> transaction on your credit balance.
            <br><br>
For more details, login to our app and go to Transaction Report page. Click the button below<br><br>

<a href="<?php echo $data['login_url'] ?>" style="background-color: #D03C0F;color: #FFFFFF;display: block;padding: 10px;text-decoration: none;width: 130px;" target="_blank">Login to our App</a><em style="font-style:italic; font-size: 12px; color: #aaa;">or visit here: <?php echo $data['company_url'] ?></em>
            <br>
			<br>
            <!-- ### END CONTENT ### -->
