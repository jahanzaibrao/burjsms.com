...
Your client is running low on Credits for one of the assigned routes. Please add more credits for their uninterrupted messaging experience. Client details are:
<br>
<ul>
<li>Login ID: <?php echo $data['client_loginid'] ?></li>
<li>Email ID: <?php echo $data['client_email'] ?></li>
<li>Mobile: <?php echo $data['client_mobile'] ?></li>
</ul>
            <br><br>
