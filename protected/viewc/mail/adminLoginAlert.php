        ...
        <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" bgcolor="#ffffff">
          <tr>
            <td class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff; padding-left: 30px; padding-right: 30px; font-size: 14px; line-height: 20px; font-family: Helvetica, sans-serif; color: #333;">
              ...
              </div><br>Your account was logged in with Admin privileges. Below are the details for this login<br><br>
              ...
              <table width="500" border="0">
                ...
                <tr>
                  ...
                  <td><?php
                      ...
                      $pldata = unserialize($data['platform']);
                      $plstr = '<div style="border-top-color:#35b8e0;border-bottom-color:#35b8e0;white-space:normal !important;max-width:500px;word-wrap:break-word;border-top:3px solid transparent;border-bottom:3px solid transparent;font-size:12px !important;padding:12px !important;">
                                                         <div class="block"><b>System:</b> ' . $pldata['system'] . '</div>
                                                     <div class="block"><b>Browser:</b> ' . $pldata['browser'] . '</div>
                                                    <div class="block"><b>IP:</b> ' . $pldata['ip'] . '</div>
                                                    <div class="block"><b>Location:</b> ' . $pldata['city'] . ', ' . $pldata['country'] . '</div>
                                                    </div>';
                      echo $plstr;
              ...
              This email is part of a regular login alert notification. If you do not recognize this Login please reset your password and block this IP.
