...
Here is your OTP (One-time Password) for verification:
            <br><br>
			<table width="200" border="0">
  <tr>
    <td><strong>OTP</strong></td>
    <td><span style="font-size:22px;letter-spacing:2px;"><?php echo $data['otp']; ?></span></td>
  </tr>
  
</table><br>
Please enter this OTP on the reset password page when asked. OTP is valid for current session Only.<br><br>
            <!-- ### END CONTENT ### -->
