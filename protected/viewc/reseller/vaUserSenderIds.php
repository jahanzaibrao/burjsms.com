                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                ...
                                <!-- start content -->
                                <div class="col-md-12">
                                    <h4> <?php echo SCTEXT('Sender ID')?></h4>
                                    <hr>
                                    
                                    <div class="">
                                          <table id="t-usid" data-plugin="DataTable" data-options="{
                                            ajax: '<?php echo Doo::conf()->APP_URL ?>getAllSenders/<?php echo $data['user']->user_id ?>', language: {url:'//cdn.datatables.net/plug-ins/1.10.20/i18n/<?php echo locale_get_display_language($_SESSION['APP_LANG']) ?>.json'}, responsive: {breakpoints: [
