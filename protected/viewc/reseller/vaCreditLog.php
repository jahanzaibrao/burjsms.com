                    ...
                    <div class="col-md-12">
                        <div class="widget p-lg">
                            <div class="row no-gutter">
                                ...
                                <!-- start content -->
                                <div class="col-md-12">
                                    <h4><?php echo SCTEXT('Credit Log')?></h4>
                                    <hr>
                                    ...
                                    <div class="">
                                          <table id="t-crelog" data-plugin="DataTable" data-options="{
                                            ajax: '<?php echo Doo::conf()->APP_URL ?>getCreditLog/Select Date/<?php echo $data['user']->user_id ?>', order:[], language: {url:'//cdn.datatables.net/plug-ins/1.10.20/i18n/<?php echo locale_get_display_language($_SESSION['APP_LANG']) ?>.json'}, serverSide: true, processing: true, ordering: false, responsive: {breakpoints: [
            ...
            { name: 'phone',   width: 480 }
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <?php if($data['user']->account_type==0){ ?><th><?php echo SCTEXT('Route')?></th><?php } ?>
