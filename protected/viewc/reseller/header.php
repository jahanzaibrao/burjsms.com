    ...
    <div class="navbar-container container-fluid topbar" style="">
        <div class="collapse navbar-collapse" id="app-navbar-collapse" style="">
            ...
            <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
                ...
                <?php if ($_SESSION['permissions']['reseller']['user_monitor'] == "on") { ?>
                    <li>
                        <a title="Monitor" href="<?php echo Doo::conf()->APP_URL ?>systemMonitor"><i class="zmdi zmdi-hc-lg zmdi-desktop-mac"></i> &nbsp;<span><?php echo SCTEXT('Monitor') ?></span>
                        </a>
                    </li>
                <?php } ?>
                ...
                <li class="dropdown">
                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-hc-lg zmdi-balance-wallet "></i> <?php echo Doo::conf()->currency . ' ' . $_SESSION['credits']['wallet']['amount'] ?>
                    </a>
                    ...
                    <div class="row dropdown-menu animated flipInY">
                        <div class="widget m-b-0">
                            ...
                            <div class="m-t-xs p-l-sm p-r-sm">
                                <div class="p-l-xs col-md-6 col-sm-6 col-xs-6">
                                    <span class="label label-primary label-flat label-md"><?php echo SCTEXT('Wallet') ?></span>
                                </div>

                                <div class="p-r-xs text-right col-md-6 col-sm-6 col-xs-6">
                                    <h5 class="m-t-xs text-dark"><?php echo Doo::conf()->currency . ' ' . $_SESSION['credits']['wallet']['amount'] ?></h5>
                                </div>
                            ...
                            <div class="p-t-xs widget-body">
                                ...
                                <?php } ?>
                                <?php if (Doo::conf()->allow_buy_sms == 1) { ?>
                ...
                <?php if (Doo::conf()->force_offline_payment == 1) { ?>
                    <li>
                        <a href="<?php echo Doo::conf()->APP_URL ?>purchaseCredits" class="btn btn-inverse"><i class="m-r-xs fa-lg fa fa-dollar"></i> <?php echo SCTEXT('Buy SMS') ?></a>
                    </li>
                <?php } ?>
