            ...
            <div class="style-block">
                <div class="form-block">
                    <div>
                        ...
                        <div class="form-subtitle">Complete a short registration to get your api key!</div>
                    </div>
                    <div class="register-form" id="register-div">
                        <form id="register_form" method="post" style="" autocomplete="off">
                            <?php wp_nonce_field( 'submit_action', 'csrf'); ?>
                            <div class="d-flex reg-input">
                                <input class="style-input modal-email-get-start" name="email" type="email" placeholder="Email Address" required="" autocomplete="email">
                            </div>
<!--                            <div class="d-flex reg-input mt-2">-->
<!--                                <input class="style-input modal-email-get-start" name="password" type="password" placeholder="Password" required="" autocomplete="new-password">-->
<!--                            </div>-->
                ...
                <div class="img-block"><img src="<?php echo esc_url(CONVEY_PLUGIN_DIR.'/app/widget/images/img-rocket.jpg') ?>" alt="ConveyThis"></div>
            </div>
        </div>
    </div>
</div>