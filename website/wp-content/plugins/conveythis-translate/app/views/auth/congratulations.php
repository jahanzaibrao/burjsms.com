        ...
        <div class="wrap-congratulation">
            ...
            <div class="animation-image">
                ...
                <div class="main-image-front">
                    <img id="animatedImage" src="<?php echo esc_url(CONVEY_PLUGIN_PATH)?>app/widget/images/header-design-2.webp" alt="Animated">
                </div>

                <div class="main-image-front">
                    <img id="animatedImageFront" src="<?php echo esc_url(CONVEY_PLUGIN_PATH)?>app/widget/images/header-design-1.webp" alt="Animated">
                </div>
             
                <div class="main-image-front-back">
                    <img id="animatedImageFront" src="<?php echo esc_url(CONVEY_PLUGIN_PATH)?>app/widget/images/header-design-3.webp" alt="Animated">
                </div>
