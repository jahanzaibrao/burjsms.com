...
class DooController
{
    ...
    public function saveRenderedC($path, $templatefile, $data = NULL, $enableControllerAccess = False, $includeTagClass = True)
    {
        if ($enableControllerAccess === true) {
            return $this->view()->saveRenderedC($path, $data, $this, $includeTagClass);
        } else {
            return $this->view()->saveRenderedC($path, $data, null, $includeTagClass);
        }
    }
