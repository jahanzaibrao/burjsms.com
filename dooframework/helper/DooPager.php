...
class DooPager{
     ...
     * @var string
     */
    public $inactivePrevCss = 'prev disabled';

    /**
     * CSS class name for inactive links
     * @var string
     */
    public $inactiveNextCss = 'next disabled';

    /**
     * CSS class name for selected current link
     * @var string
     */
    public $currentCss = 'current_page';
...
.inactivePrev, .inactiveNext{
     ...
     */
    function  __construct($baseURL='', $totalItems=120, $itemPerPage=10, $maxlength=10, $prevText='Previous', $nextText='Next'){
    ...
    public function paginate($page, $itemPerPage=0){
        ...
        if($this->_noNextPrev)
            $this->components['prev_link'] = ($this->currentPage != 1 && $this->totalItem >= $this->maxLength) ? "<li class=\"{$this->prevCss}\"><a  href=\"{$this->baseUrl}/{$prev_page}\">{$this->prevText}</a> </li>":"<li class=\"{$this->inactivePrevCss}\"><a href='javascript:void(0);'>{$this->prevText}</a></li> ";
        else
            $this->output = ($this->currentPage != 1 && $this->totalItem >= $this->maxLength) ? "<li class=\"{$this->prevCss}\"><a  href=\"{$this->baseUrl}/{$prev_page}\">{$this->prevText}</a></li> ":"<li class=\"{$this->inactivePrevCss}\"><a href='javascript:void(0);'>{$this->prevText}</a></li> ";
        ...
        if($this->totalPage > $this->maxLength){
            ...
            for($i=1;$i<=$this->totalPage;$i++){
                ...
                if($i==1 || $i==$this->totalPage || in_array($i,$range)){
                    ...
                    $this->output .= ($i == $this->currentPage) ? "<li><a class =\"{$this->currentCss}\" href=\"javascript:void(0);\">$i":"<li><a class=\"{$this->pagesCss}\"  href=\"{$this->baseUrl}/$i\">$lastDot $i";
            ...
            for($i=1;$i<=$this->totalPage;$i++){
                $this->output .= ($i == $this->currentPage) ? "<li><a class=\"{$this->currentCss}\" href=\"javascript:void(0);\">$i</a></li> ":"<li><a class=\"{$this->pagesCss}\" href=\"{$this->baseUrl}/$i\">$i</a></li> ";
            }
